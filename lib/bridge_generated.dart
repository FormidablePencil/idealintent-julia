...
abstract class FlutterRustBridgeExample {
  Future<String> upload(
      {required BasicText content, String? secretEncryptionKey, dynamic hint});
...
class FlutterRustBridgeExampleImpl
  ...
  Future<String> upload(
          {required BasicText content,
          String? secretEncryptionKey,
          dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_upload(
            port_,
            _api2wire_box_autoadd_basic_text(content),
  ...
  ffi.Pointer<wire_BasicText> _api2wire_box_autoadd_basic_text(BasicText raw) {
    final ptr = inner.new_box_autoadd_basic_text();
    _api_fill_to_wire_basic_text(raw, ptr.ref);
    return ptr;
  }
  ...
  void _api_fill_to_wire_basic_text(BasicText apiObj, wire_BasicText wireObj) {
    wireObj.title = _api2wire_String(apiObj.title);
    wireObj.body = _api2wire_String(apiObj.body);
  }

  void _api_fill_to_wire_box_autoadd_basic_text(
      BasicText apiObj, ffi.Pointer<wire_BasicText> wireObj) {
    _api_fill_to_wire_basic_text(apiObj, wireObj.ref);
  }
...
class FlutterRustBridgeExampleWire implements FlutterRustBridgeWireBase {
  ...
  void wire_upload(
    int port_,
    ffi.Pointer<wire_BasicText> content,
  ...
  late final _wire_uploadPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, ffi.Pointer<wire_BasicText>,
              ffi.Pointer<wire_uint_8_list>)>>('wire_upload');
  late final _wire_upload = _wire_uploadPtr.asFunction<
      void Function(
          int, ffi.Pointer<wire_BasicText>, ffi.Pointer<wire_uint_8_list>)>();
  ...
  ffi.Pointer<wire_BasicText> new_box_autoadd_basic_text() {
    return _new_box_autoadd_basic_text();
  }

  late final _new_box_autoadd_basic_textPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<wire_BasicText> Function()>>(
          'new_box_autoadd_basic_text');
  late final _new_box_autoadd_basic_text = _new_box_autoadd_basic_textPtr
      .asFunction<ffi.Pointer<wire_BasicText> Function()>();
...
class wire_BasicText extends ffi.Struct {
